...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* DONE Create crd schema                                           :noexport:
  CLOSED: [2019-05-30 Thu 11:08]
https://blog.heptio.com/an-introduction-to-extending-kubernetes-with-customresourcedefinitions-76deb675b27a
* DONE [#A] CRD vs API server aggregation                          :noexport:
  CLOSED: [2019-05-30 Thu 14:22]
https://www.manifold.co/blog/the-state-of-custom-resource-definitions-in-kubernetes-5498425dd553
...
* TODO create crd controller                                       :noexport:
https://itnext.io/building-an-operator-for-kubernetes-with-the-sample-controller-b4204be9ad56

https://github.com/kubernetes/sample-controller
* TODO Client-go project: provides us with packages using which we can easily create go client and access the Kubernetes cluster. :noexport:
